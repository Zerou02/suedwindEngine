...
export class TileMapEditorScene {
    ...
    constructor(spriteSheetSrc) {
        ...
        this.spriteSheet = new SpriteSheet(new Sprite(spriteSheetSrc, { x: 0, y: 0 }, { x: 60, y: 60 }, this.scene, spriteSheetLvl), 2, 16);
        let mapLayer = new Layer({ x: 200, y: 200, h: 500, w: 500 }, "map", 1, false, this.scene.layerManager);
        ...
        mapLayer.canvas.addEventListener("mousedown", (e) => {
            let totalTileSize = 2 * this.spriteSheet.padding + this.spriteSheet.tileSize;
            ...
            mapLayer.canvas
                ...
                this.spriteSheet.padding, this.spriteSheet.currentSelectedPicture.y * totalTileSize +
                this.spriteSheet.padding, this.spriteSheet.tileSize, this.spriteSheet.tileSize, Math.floor((e.x - mapLayer.dimensions.x) / this.gridSize) *
