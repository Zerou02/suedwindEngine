...
export const createCanvas = (x: number, y: number, width: number, height: number) => {
...
export const createButton = (dimensions: Dimensions, text: string, onClickFn: (e: MouseEvent) => void) => {
...
export const createLabel = (dimensions: Dimensions, text: string, id: string | null = null) => {
