...
const borderThickness = Number(
  getComputedStyle(body).getPropertyValue("--borderThickness").split("px")[0]
);
...
const topMenu = createElement("top", "div", "menu") as HTMLDivElement;
const leftMenu = createElement("left", "div", "menu") as HTMLDivElement;
const rightMenu = createElement("right", "div", "menu") as HTMLDivElement;
const bottomMenu = createElement("bottom", "div", "menu") as HTMLDivElement;
const sizeMenuBars = () => {
  ...
  sizeElement(
    ...
    window.innerHeight - MenuBarDimensions.topHeight - 3 * borderThickness
  );
  ...
  positionElement(
    rightMenu,
    window.innerWidth - MenuBarDimensions.rightWidth - 2 * borderThickness,
    MenuBarDimensions.topHeight + borderThickness
  );
  sizeElement(
    bottomMenu,
    window.innerWidth -
      ...
      MenuBarDimensions.rightWidth -
      4 * borderThickness,
    MenuBarDimensions.bottomHeight
  );
  positionElement(
    bottomMenu,
    MenuBarDimensions.leftWidth + borderThickness,
    window.innerHeight - MenuBarDimensions.bottomHeight - 2 * borderThickness
  );
  initGraphic(
    pos.new(
...
window.addEventListener("mousemove", (event) => {
  ...
  let border: "leftWidth" | "rightWidth" | "topHeight" | "bottomHeight" =
    "leftWidth";
